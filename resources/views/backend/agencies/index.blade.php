...
@section('content')
    <div class="panel">
        ...
        <span class="panel-title">
            <strong>បញ្ជីភ្នាក់ងារពត៌មាន</strong>
        </span>
        </div>
        <div class="panel-body">
            <form action="{{url('/agency/search')}}" class="form-horizontal" method="get">
                <div class="row">
            ...
            <table class="table table-bordered table-hover">
                ...
                @foreach($employees as $emp)
                    <tr>
                        ...
                        <td>{{$emp->is_agency=='yes'?'មែន':'មិនមែន'}}</td>
