...
@section('content')
    <div class="panel">
        ...
        <span class="panel-title">
             <strong>បញ្ជីក្រុមហ៊ុនផ្តល់សេវា</strong>
        </span>
        &nbsp;&nbsp;<a href="{{url('/enterprise/create')}}"><i class="fa fa-plus"></i> បង្កើតថ្មី</a>
        </div>
        <div class="panel-body">
            <form action="{{url('/enterprise/search')}}" class="form-horizontal" method="get">
            <div class="row">
            ...
            <table class="table table-bordered table-hover">
                ...
                @foreach($enterprises as $com)
                    <tr>
                        ...
                        <td>{{$com->other}}</td>
                        <td>
                            <a href="{{url('/enterprise/edit/'.$com->id)}}" title="កែប្រែ"><i class="fa fa-edit text-success"></i></a>&nbsp;&nbsp;
                            <a href="{{url('/enterprise/delete/'.$com->id.'?page='.@$_GET['page'])}}" title="លុប" onclick="return confirm('តើអ្នកពិតជាចង់លុបមែនទេ?')"><i class="fa fa-trash text-danger"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
